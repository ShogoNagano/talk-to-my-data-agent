...
class RunChartsResult(BaseModel):
    ...
    fig3_json: str | None = None
    fig4_json: str | None = None
    code: str | None = None
    metadata: RunAnalysisResultMetadata
    ...
    @property
    def fig3(self) -> go.Figure | None:
        return go.Figure(json.loads(self.fig3_json)) if self.fig3_json else None

    @property
    def fig4(self) -> go.Figure | None:
        return go.Figure(json.loads(self.fig4_json)) if self.fig4_json else None
